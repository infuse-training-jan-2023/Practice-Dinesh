# import sys
# sys.path.append('../')
from arr_manipulation import ArrManipulation
import unittest
...
class TestArrManipulation(unittest.TestCase):
    ...
    def test_for_char_input(self):
        self.assertEqual("error:: '<' not supported between instances of 'str' and 'int'",self.obj_arr_manipulation.element_at("y"))
    ...
    def test_for_negative_startpos(self):
        self.assertEqual("out of bonds", self.obj_arr_manipulation.non_inclusive_range(
            -1, 5))
